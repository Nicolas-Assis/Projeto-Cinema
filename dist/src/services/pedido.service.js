...
let PedidoService = class PedidoService {
    ...
    async adicionarIngresso(pedidoId, ingressoId) {
    ...
    async removerIngresso(pedidoId, ingressoId) {
        await this.findOne(pedidoId);
        return this.prisma.pedido.update({
            where: { id: pedidoId },
    ...
    async adicionaLanche(pedidoId, lancheId) {
        await this.findOne(pedidoId);
    ...
    async removerLanche(pedidoId, lancheId) {
        await this.findOne(pedidoId);
